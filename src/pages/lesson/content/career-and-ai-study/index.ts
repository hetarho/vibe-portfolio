...
export const careerAndAiStudyDeck: DeckDef = {
  slides: [
    ...
    { id: 'C4', part: PART.market, title: '입구는 FE·BE, 목표는 프로덕트 엔지니어', component: FrameSlide },
    { id: 'C5', part: PART.aptitude, title: '⭐ 첫 역할 체크 13문항', component: AptitudeTestSlide },
    { id: 'C6', part: PART.aptitude, title: '첫 역할 해석 가이드', component: AptitudeGuideSlide },
    { id: 'C7', part: PART.map, title: '결과 같이 뜯어보기', component: ResultTalkSlide },
    { id: 'C8', part: PART.map, title: '신입 시장의 진입 경로', component: FieldMapSlide },
    { id: 'C9', part: PART.map, title: '첫 취업 · FE vs BE', component: DayInLifeSlide },
    { id: 'C10', part: PART.talk, title: '한쪽으로 들어가 제품 전체로', component: CareerTalkSlide },
    ...
    { id: 'C16', part: PART.why, title: '프로덕트 엔지니어의 기본기 전략', component: RedefineSlide },
  ...
  shortcuts: [
    { key: 'a', slideId: 'C5', label: '첫 역할 체크' },
