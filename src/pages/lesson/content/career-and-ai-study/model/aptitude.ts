...
export const QUESTIONS: AptitudeQuestion[] = [
  {
    no: 1,
    axis: 'tendency',
    a: '새 서비스를 쓰면 화면 디자인·전환 애니메이션에 먼저 눈이 간다',
    b: '"이 데이터는 어디에 어떻게 저장될까"가 먼저 궁금하다',
  },
  {
    no: 2,
    axis: 'tendency',
    a: '팀플에서 사용자가 보는 화면을 완성하는 역할을 맡고 싶다',
    b: '로그인·데이터 처리 같은 뒷단 로직을 맡고 싶다',
  },
  {
    no: 3,
    axis: 'tendency',
    a: '내가 만든 화면을 친구가 "예쁘다"고 할 때 뿌듯할 것 같다',
    b: '느리던 처리를 몇 배 빠르게 만들었을 때 뿌듯할 것 같다',
    pivotal: true,
  },
  {
    no: 4,
    axis: 'tendency',
    a: '결과가 즉시 눈에 보여야 동기부여가 된다',
    b: '눈에 안 보여도 로그와 숫자로 확인되면 충분하다',
  },
  {
    no: 5,
    axis: 'tendency',
    a: '디자이너 시안을 픽셀 단위로 맞추는 작업, 재밌을 것 같다',
    b: '그건 좀 답답할 것 같다',
  },
  {
    no: 6,
    axis: 'tendency',
    a: '"버튼이 안 눌려요" 문제를 파고들고 싶다',
    b: '"데이터가 꼬였어요" 문제를 파고들고 싶다',
    pivotal: true,
  },
  {
    no: 7,
    axis: 'tendency',
    a: '발표자료·포스터 만들 때 배치와 색을 오래 고민하는 편이다',
    b: '자료구조·DB 같은 논리 과목이 상대적으로 잘 맞는다',
  },
  {
    no: 8,
    axis: 'tendency',
    a: '개발자도구(F12)로 남의 사이트 구조를 구경해본 적 있다 / 흥미롭다',
    b: '별로 안 궁금하다',
  },
  {
    no: 9,
    axis: 'tendency',
    a: '다양한 기기·화면 크기에서 어떻게 보일지 고민하는 게 좋다',
    b: '규칙과 구조를 세우고 지키게 만드는 일이 좋다',
  },
  {
    no: 10,
    axis: 'tendency',
    a: '새 UI 트렌드·인터랙션 소식에 끌린다',
    b: '새 아키텍처·인프라 기술 소식에 끌린다',
  },
  {
    no: 11,
    axis: 'platform',
    a: '링크 하나로 누구나 바로 접근하는 게 매력적이다',
    b: '홈 화면 아이콘과 푸시 알림으로 일상에 들어가는 게 매력적이다',
  },
  {
    no: 12,
    axis: 'platform',
    a: '고치면 즉시 모든 사용자에게 반영되는 배포가 좋다',
    b: '카메라·GPS·센서 등 기기 기능을 다루는 게 흥미롭다',
  },
  {
    no: 13,
    axis: 'platform',
    a: '하나 만들어 PC·모바일 다 대응하는 효율이 좋다',
    b: '스토어 심사가 있어도 네이티브의 매끄러운 경험을 만들고 싶다',
  },
]
...
export const TRACK_INFO: Record<Track, { label: string; line: string; detail: string }> = {
  frontend: {
    label: 'FE 성향 뚜렷',
    line: '화면과 사용자 경험 쪽',
    detail: '눈에 보이는 결과에서 동기를 얻는 편입니다. 프론트엔드부터 파보세요.',
  },
  backend: {
    label: 'BE 성향 뚜렷',
    line: '구조와 데이터 쪽',
    detail: '보이지 않는 곳의 규칙과 성능에 반응합니다. 백엔드부터 파보세요.',
  },
  fullstack: {
    label: '아직 데이터 부족 · 풀스택형 출발',
    line: '둘 다 찍먹해보고 결정',
    detail: '처음 6개월 기초는 어차피 겹칩니다. 해보고 정하는 게 가장 빠릅니다.',
  },
}
