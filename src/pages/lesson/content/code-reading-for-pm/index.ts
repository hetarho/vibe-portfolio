 ...
 * ③ 3주차부터 혼자 돌릴 커리큘럼과 코치 프롬프트를 들고 가는 것까지 간다.
 *
 * 강사가 함께하는 건 2주뿐이다. 그래서 마지막 두 화면이 숙제가 아니라 혼자 돌릴 커리큘럼이고,
 ...
 * PART 2는 예제를 버리고 실제 레포(Cal.com, pretty-bytes) 링크를 열어 같은 순서로 읽는다.
 */
export const codeReadingForPmDeck: DeckDef = {
  slides: [
    ...
    { id: 'R14', part: PART.repo, title: '에러 로그 앞 세 줄', component: ErrorLogSlide },
    ...
    { id: 'R26', part: PART.closing, title: '⭐ 같이 2주, 그다음은 혼자', component: HandoffSlide },
